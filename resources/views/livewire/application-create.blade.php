              ...
              <form class="row g-3" wire:submit.prevent='store' method="POST">
                <div class="row mt-4">
                  ...
                  <div class="col-2">
                    ...
                    <input type="text" class="form-control" id="premise" wire:model='premise'>
                  ...
                  <div class="col-6">
                    ...
                    <select class="form-select" id="application_type" wire:model='application_type'>
                      <option selected value="penggantian">Penggantian Tong Hilang</option>
                ...
                <div class="row mt-4">
                  ...
                  <div class="col-2">
                    ...
                    <input type="text" class="form-control" id="recipient_status" wire:model='recipient_status'>
