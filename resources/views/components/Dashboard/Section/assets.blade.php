        ...
        <div class="row">
            ...
            {{-- <div class="col-xxl-4 col-xl-12 mt-2">
                ...
                <div class="card info-card customers-card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">MRB <span>| This Year</span></h5>
            ...
            {{-- <div class="col-xxl-4 col-xl-12 mt-2">
                ...
                <div class="card info-card customers-card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">ES <span>| This Year</span></h5>
                        ...
                        <div class="activity">
                            <div class="activity-item d-flex">
                                ...
                                <div class="activity-content">
                                    Bin have been added {{$asset_bin_latest_created->diffForHumans()}}
                                </div>
                            </div>
                            ...
                            <div class="activity-item d-flex">
                                ...
                                <div class="activity-content">
                                    Other Assets has been added {{$asset_others_latest_created->diffForHumans()}}
                                </div>
                            </div>
                        </div>
