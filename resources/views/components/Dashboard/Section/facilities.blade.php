            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    <div class="card info-card sales-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Landfill Management <span>| Today</span></h5>
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    <div class="card info-card revenue-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Incinerator <span>| This Month</span></h5>
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    ...
                    <div class="card info-card customers-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Transfer Station <span>| This Year</span></h5>
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    ...
                    <div class="card info-card customers-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">LTP <span>| This Year</span></h5>
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    ...
                    <div class="card info-card customers-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">MRF <span>| This Year</span></h5>
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    ...
                    <div class="card info-card customers-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Buy Back Center <span>| This Year</span></h5>
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    ...
                    <div class="card info-card customers-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Eco Green <span>| This Year</span></h5>
                ...
                <div class="col-xxl-4 col-xl-12 mt-2">
                    ...
                    <div class="card info-card customers-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Anaerobic Digester <span>| This Year</span></h5>
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", () => {
                                    new ApexCharts(document.querySelector("#reportsChart"), {
                                        ...
                                        colors: ['#4154f1', '#2eca6a', '#ff771d', '#FF0000', '#8B8000'],
                                        fill: {
                                            type: "gradient",
                                            gradient: {
                                                shadeIntensity: 1,
